...
- Name: TC002.spec.ts >> Add Employee test
- Location: tests\TC002.spec.ts:3:5

# Error details

```
Error: ENOENT: no such file or directory, stat 'C:\New folder\Playwright\HRMS\2023-06-23.png'
```
    ...
    - generic [ref=f2e1]:
      ...
      - generic [ref=f2e6]:
        - generic [ref=f2e12]:
          ...
          - textbox "Code" [ref=f2e16]: "12662"
          - generic [ref=f2e17]: Last Name *
          - textbox "Last Name *" [ref=f2e18]: Gangathade
          - generic [ref=f2e19]: First Name *
          - textbox [ref=f2e20]: Abhijit
          - generic [ref=f2e21]: Middle Name
          - textbox "Middle Name" [ref=f2e22]: Balaji
          - generic [ref=f2e23]: Nick Name
          - textbox "Nick Name" [active] [ref=f2e24]: Abhi
          - generic [ref=f2e25]: Photo
          - button "Photo" [ref=f2e26]
          - generic [ref=f2e27]:
            - button "Save" [ref=f2e28]
...
```ts
  ...
  27 |         await expect(frame.locator(this.titleaddEmp)).toHaveText('PIM : Add Employee');
  28 |         console.log("Add employee page loaded");
  29 |         await frame.locator(this.lastName).fill(this.LastName);
  30 |         await frame.locator(this.firstname).fill(this.FirstName);
  31 |         await frame.locator(this.middlename).fill(this.MiddleName);
  32 |         await frame.locator(this.nickname).fill(this.NickName);
> 33 |         await frame.locator(this.firly).setInputFiles(this.filepath);
     |         ^ Error: ENOENT: no such file or directory, stat 'C:\New folder\Playwright\HRMS\2023-06-23.png'
  34 |         await frame.locator(this.save).click();
  35 |         await expect(frame.locator(this.titlepersonaldetail)).toHaveText('Personal Details');
  36 |         console.log("Employee added succesfully. you can edit or add more details now.");
  37 | 
  38 |     }
  39 | 
  40 | }
