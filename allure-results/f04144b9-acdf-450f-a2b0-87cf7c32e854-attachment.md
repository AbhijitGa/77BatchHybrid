...
> 37 |         await expect(frame.locator(this.titlepersonaldetail)).toHaveText('Personal Details');
     |                                                               ^ Error: expect(locator).toHaveText(expected) failed
  38 |         await this.page.waitForTimeout(3000);
  39 |         console.log("Employee added succesfully. you can edit or add more details now.");
  40 | 
  41 |     }
  42 | 
  43 | }
